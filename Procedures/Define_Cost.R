...
Cost2 <- function(trip = 0, cons = 0, price.f = 0, n.h = 0, n.p = 0, price.h = 0, price.p = 0) {
  ...
  return(trip * cons * price.f / 100 + n.h * price.h + n.p * price.p)
}
...
# Cost2(trip = 100, cons = 8, price.f = 1, n.h = 10, n.p = 20, price.h = 3, price.p = 1)
# Cost2(trip = 100, cons = c(5, 8, 10), price.f = 1, n.h = 10, n.p = 20, price.h = 3, price.p = 1)
